...
// This will generate the SQL needed to fix the database schema issues
// Usage: node fix-database-issues.js
...
fs.writeFileSync(path.join(__dirname, 'database-fix.sql'), sql);

console.log('Database fix SQL has been generated in database-fix.sql');
console.log('\\nTo fix the database issues:');
console.log('1. Open your Supabase SQL Editor');
console.log('2. Copy and paste the contents of database-fix.sql');
console.log('3. Run the script');
console.log('\\nThis will:');
console.log('- Add missing columns to the products table');
console.log('- Create the categories table with sample data');
console.log('- Fix RLS policies');
console.log('- Update existing products with proper categories');
